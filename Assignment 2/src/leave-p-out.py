...
df = pandas.read_csv('../docs/2.1-Exercise.csv')

# Select feature columns (excluding Date, Time, and Target)
feature_columns = ['Open', 'High', 'Low', 'Close', 'Volume']
X = df[feature_columns].values

# Use a subset of data for demonstration (due to computational complexity)
data = X[:10]  # Use first 10 samples for demonstration
...
The following output shows the result of splitting the 2.1-Exercise data by Leave-One-Out and Leave-P-Out methods.
